...
class NurseReg(models.Model):
    ...
    faccode = models.CharField(max_length=100, null=True, blank=True)
    ...
    nursesource = models.ForeignKey(NurseSource, related_name='nurseregs',
                                    null=False)
    ...
    def __unicode__(self):
        return u"Nurse Registration for %s" % self.mom_msisdn
