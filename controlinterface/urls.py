...
urlpatterns = patterns('',
    ...
    url(r'^controlinterface/subscriptions/$', views.subscriptions, name='subscriptions'),
    # url(r'^controlinterface/login/$', views.login, name='login'),
    url(r'^controlinterface/login/$', 'django.contrib.auth.views.login',
        {'template_name': 'controlinterface/login.html',
        'authentication_form' : AuthLoginForm }, name='login'),
)
