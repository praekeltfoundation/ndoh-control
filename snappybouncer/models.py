...
class Ticket(models.Model):
    ...
    message = models.TextField(verbose_name=u'Inbound Message', null=False, blank=False)
    response = models.TextField(verbose_name=u'Outbound Response', null=True, blank=True)
...
add_introspection_rules([], ["^snappybouncer\.models\.AutoNewDateTimeField", "^snappybouncer\.models\.AutoDateTimeField"])
