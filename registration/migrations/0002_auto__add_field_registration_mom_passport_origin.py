...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'registration_registration', 'mom_passport_origin',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Registration.mom_passport_origin'
        db.delete_column(u'registration_registration', 'mom_passport_origin')
